...
export default function Portfolio() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#06070a] text-white">
      ...
      <section id="stack" className="px-6 py-18 md:px-12 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-6 shadow-[0_10px_40px_rgba(0,0,0,0.28)] backdrop-blur md:p-8">
              ...
              <div className="relative flex min-h-[720px] items-center justify-center md:min-h-[760px]">
                ...
                <motion.div
                  className="relative z-10 flex h-40 w-40 items-center justify-center rounded-full border border-white/15 bg-gradient-to-br from-cyan-400 via-blue-500 to-fuchsia-500 p-[1px] shadow-[0_0_60px_rgba(34,211,238,0.35)]"
                  animate={{
                    scale: [1, 1.04, 1],
                    rotate: [0, 6, -6, 0],
                  }}
                ...
                {stack.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-[170px] rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-4 text-left shadow-[0_10px_32px_rgba(0,0,0,0.22)] backdrop-blur-xl transition hover:border-cyan-400/30">
                        <div className="flex items-center justify-between gap-3">
                          <div
                            className={`h-2.5 w-2.5 rounded-full ${isBright ? "bg-cyan-400" : "bg-fuchsia-400"} shadow-[0_0_16px_currentColor]`}
                          />
            ...
            <div className="space-y-4">
              {stack.map((item, index) => (
                <motion.div
                  ...
                  className="min-h-[112px] rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-5 shadow-[0_10px_40px_rgba(0,0,0,0.28)] backdrop-blur"
                >
                  <div className="flex h-full items-center justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <span
                          className={`h-3 w-3 rounded-full ${index % 2 === 0 ? "bg-cyan-400" : "bg-fuchsia-400"} shadow-[0_0_16px_currentColor]`}
                        />
